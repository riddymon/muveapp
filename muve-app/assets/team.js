const team = [
  {
    name: "Candace Young, RMT",
    longTitle: "Co-Owner / Registered Massage Therapist",
    position: "Registered Massage Therapist",
    quote: "I've got your back!",
    telephone: "(519) 505-3037",
    description:
    ...
    image: require("../assets/images/candace.jpg"),
    color: "#eeb9bf",
  },
  {
    name: "Victoria Swanson, RMT",
    longTitle: "Co-Owner / Registered Massage Therapist",
    position: "Registered Massage Therapist",
    quote: "Health is wealth",
    telephone: "(226) 220-2302",
    description:
      "By studying the science of Massage Therapy and how it affects the body, I am dedicated to helping clients achieve their treatment goals, thus improving their quality of life.\n\nIn my treatments I create a customised, outcome-driven  plan for each client, addressing their individual health needs. I listen carefully to what my clients goals are, and together we form the ideal treatment plan. I truly enjoy being an RMT and feel fortunate to be an active part in client health and wellness​",
    image: require("../assets/images/vicky.jpg"),
    color: "#d97a4f",
  },
  {
    name: "Jessica Johnstone, RMT",
    longTitle: "Registered Massage Therapist",
    position: "Registered Massage Therapist",
    quote: "I’ve got what you knead",
    description:
      "I am passionate about helping others live their best lives and dedicated to making my clients feel comfortable. I put together treatment plans based on my assessment and my clients goals and believe in treating my clients as an individual opposed to just the condition.\n\nI have experience with relaxation massage, deep tissue massage, trigger point relief, and remedial exercise. As a trained PTA I understand the importance of remedial exercise and believe it is important for long term results",
    image: require("../assets/images/jessica.jpg"),
    color: "#97c29b",
  },
  {
    name: "Wan Benlate",
    position: "Thai Massage Practitioner",
    longTitle: "Thai Massage Practitioner",
